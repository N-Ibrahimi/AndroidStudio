...
//cliquer sur le button
    private OnClickListener sendMe = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (checkInput()) {
                ...
                sm.sendTextMessage(phoneNumber.getText().toString(), null,
                        smsText.getText().toString(), PendingIntent.getBroadcast(Sms.this, 0, new Intent(ENVOIE_SMS), 0), null);
...
// error si le numéro ou text n'existe pas
    protected Dialog  createdDialog(int i){
        return new AlertDialog.Builder(Sms.this).setTitle("Error:Numéro ou text sms absent")
